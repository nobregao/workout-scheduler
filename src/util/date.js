...
function getDaysToSearch(days, signal = "+") {
  return Object.keys(new Array(days).fill(null))
    ...
    .sort(function (date_actual, date_next) {
      return date_actual - date_next;
    });
}

module.exports = { isSunday, isTuesday, isThursday, isToday, formatDate, subtractDay, addDays, getDaysToSearch };